...
// ===== STEP 1: Server-Side Rendering (SSR) - Total Students =====
...
const Dashboard = ({ totalStudents, majors }) => {
  ...
  // ===== STEP 3: Client-Side Fetch - Random Student =====
              ...
              renderItem={(major) => (
                <List.Item>
                  ...
                  >
                    ...
                    >
                      {major.charAt(0).toUpperCase() + major.slice(1).replace('-', ' ')}
                    </Text>
                  </Card>
                </List.Item>
              )}
